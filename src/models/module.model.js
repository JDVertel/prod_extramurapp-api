export const MODULES = {
  encuestas: {
    ...
    columns: [
      ...
      "id_tsocial_atiende",
      "id_nutricionista_atiende",
      "id_higienista_oral_atiende",
      "convenio",
      "eps",
      "regimen",
      "grupo",
      ...
      "fecha_gest_tsocial",
      "fecha_gest_nutricionista",
      "fecha_gest_higienista_oral",
      "fecha_gest_auxiliar",
      "fecha_facturacion",
      "asig_fact",
      "agenda_tomamuestra",
    ...
    maxLengths: {
      ...
      id_nutricionista_atiende: 36,
      id_higienista_oral_atiende: 36,
      convenio: 120,
      eps: 120,
      regimen: 60,
      grupo: 30,
      ...
      numdoc: 40,
      sexo: 20,
      departamento_nacimiento: 120,
      municipio_nacimiento: 120,
      identidad_genero: 120,
      ocupacion: 255,
      nivel_ocupacion: 255,
      direccion: 255,
      telefono: 30,
    ...
    aliases: {
      ...
      idNutricionistaAtiende: "id_nutricionista_atiende",
      idNutriAtiende: "id_nutricionista_atiende",
      idNutricionista: "id_nutricionista_atiende",
      idNutricionAtiende: "id_nutricionista_atiende",
      idHigienistaOralAtiende: "id_higienista_oral_atiende",
      idEncuesta: "id_encuesta",
      fechaNac: "fecha_nac",
      departamentoNacimiento: "departamento_nacimiento",
      municipioNacimiento: "municipio_nacimiento",
      identidadGenero: "identidad_genero",
      nivelOcupacion: "nivel_ocupacion",
      ...
      status_gest_nutri: "status_gest_nutricionista",
  ...
  caracterizacion: {
    ...
    columns: [
      ...
      "grupo_familiar",
      "riesgos",
      "detalle_sedentarismo",
      "detalle_consumo_alcohol",
      "detalle_consumo_cigarrillo",
    ...
    aliases: {
      ...
      detalleSedentarismo: "detalle_sedentarismo",
      detalleConsumoAlcohol: "detalle_consumo_alcohol",
      detalleConsumoCigarrillo: "detalle_consumo_cigarrillo",
      detalleAlimentacionPocoSaludable: "detalle_alimentacion_poco_saludable",
    },
    maxLengths: {
      detalle_consumo_alcohol: 60,
      detalle_alimentacion_poco_saludable: 255,
    },
  },
  comunas_barrios: {
